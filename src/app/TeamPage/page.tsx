        ...
        <div className="flex flex-col font-Montserat">
            ...
            <div className="text-center w-[870px] h-[280px] self-center">
                ...
                <div className="mt-[16px] flex flex-row items-center justify-center">
                    ...
                    <h1 className="ms-[15px]"><img src="i7.png" alt="img" /></h1>
            ...
            <div className="flex flex-row justify-between h-[530px] self-center w-[1440px]">
                    <h1><img src="disp1.png" alt="img" /></h1>
                    <div className="flex justify-between flex-col">
                        <h1><img src="disp2.png" alt="img" /></h1>
                        <h1><img src="disp4.png" alt="img" /></h1>
                    </div>
                    <div className="flex justify-between flex-col">
                        <h1><img src="disp3.png" alt="img" /></h1>
                        <h1><img src="disp5.png" alt="img" /></h1>
                    </div>
                </div>
                ...
                <div className="flex flex-row self-center gap-[30px] mt-[112px]">
                    <div className="flex flex-col text-center">
                        <h1><img src="team4.png" alt="img" /></h1>
                    ...
                    <div className="flex flex-col text-center">
                        <h1><img src="team5.jpg" alt="img" /></h1>
                        <h1 className="font-bold text-[#252B42] mt-[30px] text-[16px]">Username</h1>
                        <h2 className="font-bold text-sm mt-[10px] text-[#737373]">Profession</h2>
                        <h2 className="self-center mt-[10px]"><img src="media.png" alt="img" /></h2>
                    </div>
                    <div className="flex flex-col text-center">
                        <h1><img src="team6.jpg" alt="img" /></h1>
                        <h1 className="font-bold text-[#252B42] mt-[30px] text-[16px]">Username</h1>
                        <h2 className="font-bold text-sm mt-[10px] text-[#737373]">Profession</h2>
                        <h2 className="self-center mt-[10px]"><img src="media.png" alt="img" /></h2>
                    </div>
                ...
                <div className="flex flex-row self-center gap-[30px] mt-[112px]">
                    ...
                    <div className="flex flex-col text-center">
                        <h1><img src="team7.jpg" alt="img" /></h1>
                        <h1 className="font-bold text-[#252B42] mt-[30px] text-[16px]">Username</h1>
                        <h2 className="font-bold text-sm mt-[10px] text-[#737373]">Profession</h2>
                        <h2 className="self-center mt-[10px]"><img src="media.png" alt="img" /></h2>
                    </div>
                ...
                <div className="flex flex-row self-center gap-[30px] mt-[112px]">
                    ...
                    <div className="flex flex-col text-center">
                        <h1><img src="team8.jpg" alt="img" /></h1>
                        <h1 className="font-bold text-[#252B42] mt-[30px] text-[16px]">Username</h1>
                        <h2 className="font-bold text-sm mt-[10px] text-[#737373]">Profession</h2>
                        <h2 className="self-center mt-[10px]"><img src="media.png" alt="img" /></h2>
                    </div>
                    <div className="flex flex-col text-center">
                        <h1><img src="team9.jpg" alt="img" /></h1>
                        <h1 className="font-bold text-[#252B42] mt-[30px] text-[16px]">Username</h1>
                        <h2 className="font-bold text-sm mt-[10px] text-[#737373]">Profession</h2>
                        <h2 className="self-center mt-[10px]"><img src="media.png" alt="img" /></h2>
                    </div>
            ...
            <div className="w-full text-center pb-[80px]">
                ...
                <h1 className="justify-self-center mt-[30px]"><img src="sm.png" alt="img" /></h1>
            </div>
