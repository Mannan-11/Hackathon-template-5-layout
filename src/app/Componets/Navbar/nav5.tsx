        ...
        <div className="flex flex-col font-Montserat">
            <nav className="w-full h-[91px] flex flex-row items-center">
                ...
                <ul className="flex flex-row text-sm font-bold ms-[82px] gap-[21px] text-[#737373]">
                 ...
                 <button className="text-white rounded bg-[#23A6F0] text-sm font-bold flex ms-[45px] hover:bg-sky-400 items-center py-[10px] px-[25px]">Become a Member<img className="ms-[15px]" src="vector.png" alt="" /></button>
            </nav>
        </div>
    )
}