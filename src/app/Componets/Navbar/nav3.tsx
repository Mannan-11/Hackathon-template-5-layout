        ...
        <div>
             <nav className="flex flex-row w-full h-[58px] bg-[#23856D]">
                    <div className="w-[1128px] h-[46px] self-center flex flex-row items-center ms-[143px]">
                        <h1 className="ms-[64px]"><img src="icn1.png" alt="img" width={16} height={16} /></h1>
                        <h1 className="ms-[5px] font-normal text-xs text-[#FFFFFF]">(225) 555-0118</h1>
                        <h1 className="ms-[20px]"><img src="icn2.png" alt="img" /></h1>
                        ...
                        <h1 className="ms-[15px]"><img src="icn3.png" alt="img" /></h1>
                        <h1 className="ms-[10px]"><img src="icn4.png" alt="img" /></h1>
                        <h1 className="ms-[10px]"><img src="icn5.png" alt="img" /></h1>
                        <h1 className="ms-[10px]"><img src="icn6.png" alt="img" /></h1>
                    </div>
                </nav>
        </div>
    )
