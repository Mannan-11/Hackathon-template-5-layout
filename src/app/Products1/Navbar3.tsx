...
export default function Navbar3() {
    ...
    return (
        ...
        <div className="flex w-[1048px] font-Montserat h-[58px] mx-[246.5px] my-2 gap-7">
            ...
            <div className="flex w-[815px] h-[58px] gap-36">
                <div className="flex w-[361px] h-[25px] gap-[15px] my-[16.75px]">
                    ...
                    <Link href="/Blog">
                        <h1 className="w-[33px] h-6 text-[#737373] text-[14px] leading-[24px] tracking-[0.2px]">Prod</h1>
                    </Link>
